...
## Ejemplos
En este repositorio podemos encontrar ejemplos de [`ARGENTINA`](https://github.com/TuQmano/geofacet_ARG/tree/master/ARGENTINA), [`CABA`](https://github.com/TuQmano/geofacet_ARG/tree/master/CABA), [`CÓRDOBA`](https://github.com/TuQmano/geofacet_ARG/tree/master/CORDOBA),  [`TUCUMÁN`](https://github.com/TuQmano/geofacet_ARG/tree/master/TUCUMAN) y secciones electorales de la [`Provincias de Buenos Aires`](https://github.com/TuQmano/geofacet_ARG/tree/master/PBA).
